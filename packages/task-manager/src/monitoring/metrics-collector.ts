...
export class MetricsCollector {
  ...
  // Counters
  private taskCreatedCounter!: Counter;
  private taskCompletedCounter!: Counter;
  private taskFailedCounter!: Counter;
  ...
  private queueWaitTimeHistogram!: Histogram;
  
  private activeTasks: Map<string, { type: string; startTime: number }> = new Map();
  ...
  recordTaskStarted(taskId: string, type: string = 'unknown'): void {
